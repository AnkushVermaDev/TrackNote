...
let tableContainerStatus = false
let TableDataContainer  = document.querySelector('.TableDataContainer')
...
export default function getselectedItemInSetting(target) {
    ...
    console.log(selectedItemInSetting.split(' ')[1]);
    ...
    if (selectedItemInSetting.split(' ')[1] === ('fa-table-list')) {

        tableContainerStatus = !tableContainerStatus
        TableDataContainer.style.display = TableDataContainer ? 'flex' : 'none';
